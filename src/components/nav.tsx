            ...
            >
                <div className="mx-auto flex max-w-[1200px] items-center justify-between px-6 py-4 md:px-12">
                    ...
                    <Magnetic strength={0.2}>
                        ...
                        >
                            <span className="flex h-9 w-9 items-center justify-center rounded-xl bg-gradient-to-br from-primary to-secondary text-white shadow-[0_8px_20px_-8px_rgba(192,103,255,0.7)] transition-transform group-hover:rotate-6">
                                <Sparkles size={16} />
                            </span>
                            <span>
                                        ...
                                        <Magnetic strength={0.25}>
                                            ...
                                            >
                                                {isActive && (
                                                    <motion.span
                                                        layoutId="nav-active"
                                                        className="absolute inset-0 rounded-full bg-gradient-to-r from-primary/25 to-secondary/25 ring-1 ring-primary/30"
                    ...
                    <div className="hidden md:block">
                        <Magnetic strength={0.3}>
                            <Link
                                href="#contact"
                                className="inline-flex items-center gap-1.5 rounded-full bg-gradient-to-r from-primary to-secondary px-5 py-2.5 text-sm font-bold text-white shadow-[0_10px_30px_-12px_rgba(192,103,255,0.7)] transition-all hover:shadow-[0_10px_30px_-10px_rgba(192,103,255,0.9)]"
                            >
                                Let&apos;s Talk
                            </Link>
                        </Magnetic>
                ...
                <motion.div
                    style={{ scaleX }}
                    className="h-[2px] origin-left bg-gradient-to-r from-primary via-secondary to-primary"
                />
            </motion.header>
                    ...
                    >
                        ...
                        >
                            ...
                            <Link
                                href="#contact"
                                onClick={() => setOpen(false)}
                                className="mt-4 block rounded-2xl bg-gradient-to-r from-primary to-secondary px-4 py-3 text-center text-sm font-bold text-white"
                            >
                                Let&apos;s Talk
                            </Link>
                        </motion.nav>
